...
class PixelToCoordinateCalculator:
    ...
    def initialize_camera_model(self):
        ...
        ##
        print self.camera_info.width
        print self.camera_info.height
    ...
    def get_transform(self):
        while not rospy.is_shutdown():
            try:
                self.trans = self.tf_buffer.lookup_transform("base_link", "blackfly_mount_link_right", rospy.Time())
    ...
    def get_3d_rays_from_camera_model(self):
        ...
        self.debug_pointcloud.header.frame_id = "blackfly_mount_link_right"
        ...
        for pixel in all_pixels:
            ...
            point_stamped.header.frame_id = "blackfly_mount_link_right"
            ##
            ...
            # now the rays are from origin of blackfly_mount_link_right frame to this transformed_point.
            # so the intersection
        ...
        #rospy.loginfo("Size: ", numpy.shape(self.intersection_array))
        # print numpy.shape(self.intersection_array)
        print self.intersection_array.shape
    ...
    def write_intersection_array_to_file(self):
        np.save(
            self.package_path + "/misc/training_images/pixel_coordinates_right.npy",
...
if __name__ == '__main__':
    ...
    while p.DEBUG_POINTCLOUD and not rospy.is_shutdown():
        ...
        rospy.loginfo("Before Exit")
        p.rate.sleep()
        rospy.loginfo("Almost")
