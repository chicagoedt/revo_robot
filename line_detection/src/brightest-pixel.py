...
class line_detection:
    ...
    node_name = "brightestpixel_lanedetection"
    namespace = rospy.get_namespace()
    if namespace == "/":
        namespace = ""

    use_mono = rospy.get_param(namespace + node_name + "/use_mono")
    use_compressed_format = rospy.get_param(namespace + node_name + "/use_compressed_format")
    subscriber_image_topic = rospy.get_param(namespace + node_name + "/subscriber_image_topic")
    publisher_image_topic = rospy.get_param(namespace + node_name + "/publisher_image_topic")
    buffer_size = rospy.get_param(namespace + node_name + "/buffer_size")
    ...
    training_file_name = rospy.get_param(namespace + node_name + "/training_file_name")
