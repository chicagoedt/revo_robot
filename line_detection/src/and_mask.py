...
# Bitwise_and Mask filter that applies a binary mask on an input image
#
# @author Basheer Subei
# @email basheersubei@gmail.com


class AndMask(LaneDetection):
...
def main(args):
    ...
    m = AndMask(namespace, node_name)

    # start the line_detector node and start listening
    rospy.init_node("and_mask", anonymous=True)
